...
// Side-effect import: регистрирует callback-handler scope 'sales'
// (воронка заявок: ✅ Сделано / ⏰ +1 день / «Что дальше?»). См. handlers/sales.ts.
import '@/lib/telegram/handlers/sales'
