...
export default function DeliveryError({
  ...
  return (
    <div className="mx-auto max-w-xl rounded-3xl border border-danger/30 bg-surface p-6 text-center shadow-[var(--shadow-card)]" role="alert">
      ...
      <h1 className="mt-4 text-xl font-bold text-fg">Не удалось загрузить маршрут</h1>
      <p className="mt-2 text-sm leading-6 text-fg-muted">Проверьте соединение и повторите загрузку.</p>
