        ...
        {isAdminLike(user.role) && (
          ...
          >
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-bg flex items-center justify-center">
                  <Bug className="w-5 h-5 text-fg-muted" strokeWidth={1.75} />
                </div>
                <div>
                  <h3 className="font-semibold text-base">Ошибки</h3>
                  <p className="text-sm text-fg-muted">Журнал сбоев на проде (in-house Sentry)</p>
                </div>
              </div>
              <ChevronRight className="w-4 h-4 text-fg-subtle" />
            </div>
