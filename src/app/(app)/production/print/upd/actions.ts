...
// buildSnapshots вынесена в обычный модуль: 'use server' допускает только
// async-экспорты, а это чистая синхронная функция (+ юнит-тесты).
import { buildSnapshots, type OrderFull } from './build-snapshots'
